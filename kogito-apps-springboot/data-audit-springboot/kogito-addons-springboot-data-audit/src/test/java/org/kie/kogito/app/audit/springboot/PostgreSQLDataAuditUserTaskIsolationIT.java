...
import org.kie.kogito.app.audit.quarkus.AbstractDataAuditUserTaskIsolationIT;
...
public class PostgreSQLDataAuditUserTaskIsolationIT extends AbstractDataAuditUserTaskIsolationIT {
    ...
    protected void publishTestData() throws Exception {
        doPublishUserTaskEvents(publisher);
    }
