...
public class TripleBetaConstraintsMetric extends TripleBetaConstraints {
    ...
    private TripleBetaConstraints delegate;

    public TripleBetaConstraintsMetric() {}

    public TripleBetaConstraintsMetric(TripleBetaConstraints original) {
        this.delegate = original;
    }

    @Override
    public TripleBetaConstraints cloneIfInUse() {
        TripleBetaConstraints clonedOriginal = delegate.cloneIfInUse();
        if (clonedOriginal == delegate) {
            return this;
        } else {
            return new TripleBetaConstraintsMetric(clonedOriginal);
        }    }

    @Override
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        delegate = (TripleBetaConstraints) in.readObject();
    }
    ...
    public boolean equals(Object object) {
        if (object instanceof TripleBetaConstraintsMetric) {
            return delegate.equals(((TripleBetaConstraintsMetric) object).delegate);
        } else {
