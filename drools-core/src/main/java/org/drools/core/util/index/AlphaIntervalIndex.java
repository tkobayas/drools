...
/**
 * 
 * Alpha Node interval indexing implementation
 *
 */
public class AlphaIntervalIndex implements Externalizable {

    private IntervalIndex<Comparable, AlphaNodeInterval> intervalIndex;

    private CompositeObjectSinkAdapter.FieldIndex fieldIndex;

    private int size;

    public AlphaIntervalIndex() {
        // constructor for serialisation
    }

    public AlphaIntervalIndex(CompositeObjectSinkAdapter.FieldIndex fieldIndex) {
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        intervalIndex = (IntervalIndex) in.readObject();
...
//        intervalIndex.addIndex(indexType, key, alphaNode);
        size++;
    }
    ...
    public void remove(AlphaNode alphaNode) {
        ...
        Comparable key = extractKey(constraint);
        IndexType indexType = extractIndexType(constraint);
//        intervalIndex.removeIndex(indexType, key);
        size--;
    }
...
//        }
//        return intervalIndex.getValues((Comparable) value);
//    }
//
//    public Collection<AlphaNode> getAllValues() {
//        return intervalIndex.getAllValues();
//    }
